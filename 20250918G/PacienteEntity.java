public class PacienteEntity implements Comparable<PacienteEntity> {
    private Long codigo;
    ...
    // Implementação do método compareTo para comparação por nome completo
    @Override
    ...
    public String toString() {
        return nomeCompleto != null ? nomeCompleto : "Sem nome";
    }
}